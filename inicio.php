<?php
	...
	$query = $conexion->query("SELECT P.idProducto, P.Nombre, P.Precio, P.Imagen, M.Nombre AS Marca FROM productos AS P INNER JOIN marcas AS M ON M.idMarca = P.Marca WHERE P.Destacado = 0 LIMIT 0, 6");
